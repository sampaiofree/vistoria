...
final class UserSettingsController extends Controller
{
    public function index(Request $request, TenantContext $tenant): InertiaResponse
    {
        ...
        return Inertia::render('Settings/Users/Index', [
            ...
            'status_options' => [
                ...
                ['value' => UserStatus::Suspended->value, 'label' => 'Suspenso'],
            ],
            'account_type_options' => [
                ['value' => UserAccountType::Member->value, 'label' => 'Membro'],
    ...
    private function payload(User $user, Request $request): array
    {
        return [
            ...
            'account_type_label' => $user->isCompanyAdmin() ? 'Administrador da Empresa' : 'Membro',
