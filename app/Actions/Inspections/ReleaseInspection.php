...
final class ReleaseInspection
{
    ...
    public function handle(Inspection $inspection, User $actor): Inspection
    {
        return $this->transition->handle(
            $inspection, $actor, [InspectionStatus::ReportGenerated], InspectionStatus::Released, 'released_at',
            fn (Inspection $locked) => $this->requireResponsible($locked, InspectionResponsibility::Releaser, $actor),
        );
    }
}
