            ...
            <table aria-hidden="true" class="min-w-full divide-y divide-slate-200 text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    <tr v-for="row in skeletonRows" :key="row" class="animate-pulse">
                        ...
                        <td class="px-5 py-4"><div class="ml-auto h-9 w-28 rounded bg-slate-200" /></td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <tbody class="divide-y divide-slate-200">
                    <tr v-for="inspection in rows" :key="inspection.public_id" class="align-top">
                        <th scope="row" class="px-5 py-4 text-left font-normal">
                            <Link :href="inspection.next_action.href" class="font-semibold text-slate-900 transition hover:text-slate-600">
                                {{ inspection.number }}
                            </Link>
                        ...
                        <td class="px-5 py-4">
                            <div class="flex flex-wrap gap-2">
                                <span
                                    ...
                                    class="inline-flex items-center rounded border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-700"
                                >
                        ...
                        <td class="px-5 py-4">
                            <Link
                                ...
                                class="inline-flex min-h-11 items-center justify-center rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 hover:text-slate-900"
                            >
