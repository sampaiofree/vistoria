...
> **Tipo:** runbook de referência. Os comandos abaixo devem ser adaptados ao
> ambiente real; a existência deste arquivo não é evidência de implantação ou
> homologação de uma produção específica.
...
O checklist resumido está em [`14-DEPLOY-HETZNER.md`](14-DEPLOY-HETZNER.md).
